...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authentication', '0004_internalfilesstaff_staff'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clients_job_orders', to='authentication.client')),
                ('va_assigned', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vas_job_orders', to='authentication.staff')),
            ],
            options={
                'abstract': False,
            },
